 <?php
  ...
  $prod=Gestion_Productos::ReadbyId($producto[4]);
...
<div class="form-style-6">
  ...
  <form   action="../controller/publicaciones.controller.php" method="POST">
        ...
        <input   type="text" placeholder="Titulo " name="Titulo"  required data-toggle="tooltip"  title="Titulo" value="<?php echo $producto[1] ?>" />
